 ...
 * 
 * Usage:
 *   1. ./craft transform-discovery/discover - Full scan (DB + Twig)
 *   2. ./craft transform-discovery/scan-templates - Templates only
 *   3. ./craft transform-discovery/scan-database - Database only
 */
