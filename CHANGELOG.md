...
- Phase 0.5 duplicate merges no longer preserve stale source or legacy bucket URLs from asset metadata when explicit URL mappings identify previous bucket addresses
